      ...
      <div style={{ flex: 1, overflowY: "auto", paddingBottom: 110 }}>
        {tab === "about" ? (
          ...
          <div style={{ padding: "16px" }}>
            ...
            <div style={{
              background: "var(--code-bg)", borderRadius: 14,
              ...
              <pre style={{ margin: 0, padding: "16px 14px", overflowX: "auto" }}>
                <code style={{
                  fontSize: 12.5, color: "var(--code-text)",
                  lineHeight: 1.75,
          ...
          <div onClick={e => e.stopPropagation()}>
            <div style={{
              ...
              <button style={{
                ...
                background: "transparent", border: "none",
                color: "var(--accent)", fontSize: 17, cursor: "pointer",
              }} onClick={onShare}>Delen</button>
              <div style={{ height: 1, background: "var(--border2)" }} />
              <button style={{
                width: "100%", padding: 18,
                background: "transparent", border: "none",
                color: "var(--accent)", fontSize: 17, cursor: "pointer",
              }} onClick={onExport}>Exporteren</button>
              <div style={{ height: 1, background: "var(--border2)" }} />
              <button style={{
                width: "100%", padding: 18,
                background: "transparent", border: "none",
                color: "var(--red)", fontSize: 17, cursor: "pointer",
              }} onClick={onDelete}>Verwijderen</button>
            </div>
            <button style={{
              width: "100%", padding: 18,
